	...
	protected void determineEncoding()
	{
		...
		if (encoding != null) 
		{
			if (encoding instanceof COSName) 
			{
				...
				if (cmap == null && cmapName != null)
				{
					...
					{
						Log.d( PDFBox.LOG_TAG, "Debug: Could not find encoding for " + encodingName );
					}
				}
			}
			else if(encoding instanceof COSStream )
			{
				if (cmap == null)
				{
					...
					{
						Log.e(PDFBox.LOG_TAG, "Error: Could not parse the embedded CMAP" );
					}
				}
			}
			else if (encoding instanceof COSDictionary) 
			{
				...
				{
					Log.e(PDFBox.LOG_TAG, "Error: Could not create the DictionaryEncoding");
				}
			}
		}
		...
		if (cmap == null && cmapName != null) 
		{
			...
			try 
			{
				...
				{
					Log.e(PDFBox.LOG_TAG, "Error: Could not parse predefined CMAP file for '" + cmapName + "'" );
				}
			}
			catch(IOException exception) 
			{
				Log.e( PDFBox.LOG_TAG, "Error: Could not find predefined CMAP file for '" + cmapName + "'" );
			}
		}
	}
	...
	private void extractToUnicodeEncoding()
	{
		...
		if( toUnicode != null )
		{
			...
			if ( toUnicode instanceof COSStream )
			{
				...
				{
					Log.e( PDFBox.LOG_TAG, "Error: Could not load embedded ToUnicode CMap" );
				}
			}
			else if ( toUnicode instanceof COSName)
			{
				...
				if (toUnicodeCmap == null) 
				{
					...
					{
						Log.e( PDFBox.LOG_TAG, "Error: Could not find predefined ToUnicode CMap file for '" + cmapName + "'" );
					}
					if( toUnicodeCmap == null)
					{
						Log.e( PDFBox.LOG_TAG,"Error: Could not parse predefined ToUnicode CMap file for '" + cmapName + "'" );
					}
				}
			}
		}
