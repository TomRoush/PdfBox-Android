...
import org.apache.pdfboxandroid.exceptions.WrappedIOException;
import org.apache.pdfboxandroid.io.PushBackInputStream;
...
public abstract class BaseParser {
     ...
     */
    public static final String PROP_PUSHBACK_SIZE = "org.apache.pdfboxandroid.baseParser.pushBackSize";
     ...
     */
    protected static final boolean FORCE_PARSING = Boolean.getBoolean("org.apache.pdfbox.forceParsing");
        ...
        while( !done )
        {
            ...
            if( c == '>')
            {
                ...
                if(c != '/')
                {
                    ...
                    Log.w("Invalid dictionary, found: '" + c + "' but expected: '/'", PDFBox.LOG_TAG);
            ...
            else
            {
                ...
                if( value == null )
                {
                    Log.w("Bad Dictionary Declaration " + pdfSource , PDFBox.LOG_TAG);
                }
                else
                {
    ...
    protected COSArray parseCOSArray() throws IOException
    {
        ...
        while( ((i = pdfSource.peek()) > 0) && ((char)i != ']') )
        {
            ...
            else
            {
                ...
                Log.w("Corrupt object reference" , PDFBox.LOG_TAG);
...
//            } 
            ...
            else
            {
                ...
                if ( readCount > 0 )
                {
                    ...
                    if ( ! foundEndstream )
                    {
                        Log.w("Specified stream length " + length 
                                + " is wrong. Fall back to reading stream until 'endstream'.", PDFBox.LOG_TAG);
