        ...
        while( !done )
        {
            ...
            if( c == '>')
            {
                ...
                if(c != '/')
                {
                    ...
                    Log.w(PDFBox.LOG_TAG, "Invalid dictionary, found: '" + c + "' but expected: '/'");
            ...
            else
            {
                ...
                if( value == null )
                {
                    Log.w( PDFBox.LOG_TAG, "Bad Dictionary Declaration " + pdfSource );
                }
                else
                {
    ...
    protected COSArray parseCOSArray() throws IOException
    {
        ...
        while( ((i = pdfSource.peek()) > 0) && ((char)i != ']') )
        {
            ...
            else
            {
                ...
                Log.w(PDFBox.LOG_TAG, "Corrupt object reference" );
...
//            } 
            ...
            else
            {
                ...
                if ( readCount > 0 )
                {
                    ...
                    if ( ! foundEndstream )
                    {
                        Log.w(PDFBox.LOG_TAG, "Specified stream length " + length 
