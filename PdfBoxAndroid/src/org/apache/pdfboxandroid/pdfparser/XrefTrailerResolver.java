...
public class XrefTrailerResolver {
    ...
    public void setStartxref( long startxrefBytePosValue )
    {
        ...
        {
            Log.w(PDFBox.LOG_TAG, "Method must be called only ones with last startxref value.");
            return;
        }
        ...
        if ( curObj == null )
        {
            ...
            Log.w(PDFBox.LOG_TAG, "Did not found XRef object at specified startxref position " + startxrefBytePosValue);
        ...
        else
        {
            ...
            while ( curObj.trailer != null )
            {
                ...
                if ( curObj == null )
                {
                    Log.w(PDFBox.LOG_TAG, "Did not found XRef object pointed to by 'Prev' key at position " + prevBytePos);
                    break;
                }
    ...
    public void setTrailer( COSDictionary trailer )
    {
        ...
        {
            // should not happen...
            Log.w( PDFBox.LOG_TAG, "Cannot add trailer because XRef start was not signalled." );
            return;
        }
    ...
    public void setXRef( COSObjectKey objKey, long offset )
    {
        ...
        {
            // should not happen...
            Log.w( PDFBox.LOG_TAG, "Cannot add XRef entry for '" + objKey.getNumber() + "' because XRef start was not signalled." );
            return;
        }
