...
//	                      envelopedData = ri.getContent(material.getPrivateKey(), "BC");
	                      envelopedData = ri.getContent(new JceKeyTransEnvelopedRecipient((PrivateKey) material.getPrivateKey()).setContentProvider("SC"));
	                      break;
	                  }
	              }
               ...
               GeneralSecurityException
    {
        ...
        EnvelopedData env = new EnvelopedData((OriginatorInfo)null, derset, encryptedcontentinfo,  (ASN1Set)null);
