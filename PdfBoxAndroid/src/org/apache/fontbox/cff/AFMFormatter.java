...
//        }
//        Rect bounds = getBounds(metrics);
//        output.println("FontBBox " + (int)bounds.left + " " + (int)bounds.top
//                + " " + (int)(bounds.left + bounds.width()) + " " + (int)(bounds.top + bounds.height()));
...
//    }TODO
            ...
            throws IOException
    {
        ...
        for (CharMetric metric : metrics)
        {
            ...
            output.print(" ");
            output.print("B " + (int) metric.bounds.left + " "
                    + (int) metric.bounds.top + " "
                    + (int) (metric.bounds.left + metric.bounds.width()) + " "
                    + (int) (metric.bounds.top + metric.bounds.height()) + " ;");
            output.println();
        }
...
//    }
    ...
    private static Rect getBounds(List<CharMetric> metrics)
    {
        Rect bounds = null;
        for(CharMetric metric : metrics)
        {
