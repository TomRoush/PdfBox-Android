...
public interface PDFontLike
{
     ...
     * PDFont subclass to retrieve the glyph outline as a Path. See the cyan rectangles in
     ...
     * PDFont subclass to retrieve the glyph outline as a Path instead. See the cyan
