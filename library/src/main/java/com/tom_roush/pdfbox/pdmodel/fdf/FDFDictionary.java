        ...
        for( int i=0; i<nodeList.getLength(); i++ )
        {
            ...
            if( node instanceof Element )
            {
                ...
                else if( child.getTagName().equals( "ids" ) )
                {
                    ...
                    {
                        Log.w("PdfBox-Android", "Error parsing ID entry for attribute 'original' ["
                            + original + "]. ID entry ignored.", e);
                    }
                    try
                    {
                    ...
                    {
                        Log.w("PdfBox-Android", "Error parsing ID entry for attribute 'modified' ["
                            + original + "]. ID entry ignored.", e);
                    }
                    setID( ids );
                }
                else if( child.getTagName().equals( "fields" ) )
                {
                    ...
                    for( int f=0; f<fields.getLength(); f++ )
                    {
                        ...
                        if (currentNode instanceof Element && ((Element)currentNode).getTagName().equals("field")) 
                        {
                            ...
                            {
                                Log.w("PdfBox-Android", "Error parsing field entry [" +
                                    currentNode.getNodeValue() + "]. Field ignored.", e);
                            }
                        }
                    }
                    setFields( fieldList );
                ...
                else if( child.getTagName().equals( "annots" ) )
                {
                    ...
                    for( int j=0; j<annots.getLength(); j++ )
                    {
                        ...
                        if( annotNode instanceof Element )
                        {
                            ...
                            {
                                Log.w("PdfBox-Android", "Error parsing annotation information [" +
