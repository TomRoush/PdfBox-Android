...
public class ShadingEnd2EndTest
{
    ...
    public void TestShading2()
    {
        try
        {
            ...
            Assert.assertEquals("(5, -5) should be white", Color.WHITE,
                bitmap.getPixel(5, height - 5));
            ...
            Assert.assertEquals("(110, -110) should be white", Color.WHITE,
                bitmap.getPixel(110, height - 110));
        }
        catch (IOException e)
        {
    ...
    private static int calcColorDiff(int a, int cb)
    {
        ...
        return Math.abs(Color.red(a) - r) + Math.abs(Color.green(a) - g) + Math.abs(
            Color.blue(a) - b);
    }
